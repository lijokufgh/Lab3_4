namespace Lab3_4
{
    public class Urav
    {
        ...
        private string uravn1; // Копия уравнения над которой происходят манипуляции.
        private char[] uravn2; // Копия уравнения над которой происходят манипуляции в виде массива символов.
        ...
        private int Modul() // Метод нахождения модуля.
        {
            ...
            return mod1; // Возвращаем результат.
        }
        private int Ix()
        {
            ...
            uravn1 = uravn1.Remove(mod2); // Удаление строки от множителя.
            uravn2 = ReverseChar(uravn1.ToCharArray()); // Перевод строки в массив символов вмести с реверсированием строки.
            uravn1 = new string(uravn2); // Перевод массива символов в строку.
            mod1 = int.Parse(uravn1); // Парсинг строки в int.
